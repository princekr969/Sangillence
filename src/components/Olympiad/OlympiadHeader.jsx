        ...
        <main className="relative z-10 h-full">
          <div className="max-sm:hidden absolute right-0 bottom-0 animate-slide-up-1">
            <div className="h-32 w-52 md:h-52 md:w-64 mb-3">
              <img
                src="https://res.cloudinary.com/dstbd40ud/image/upload/v1754641767/olympiadSOBO_imnaym.svg"
            ...
            <div className="flex flex-col justify-center">
              <div className="animate-slide-up-1 flex justify-center">
                <div className="h-32 w-64 mb-3">
                  <img
                    src="https://res.cloudinary.com/dstbd40ud/image/upload/v1754641347/sangillence_logo_qhyh1l.svg"
                    className="h-full w-full object-contain"
                    alt="Sangillence Logo"
                  />
                </div>
              </div>

              {/* Updated text for result announcement */}
              <h2 className="animate-slide-up-2 font-family-givonic-bold whitespace-nowrap text-center font-bold text-2xl sm:text-5xl md:text-3xl lg:text-4xl bg-gradient-to-r from-blue-400 via-purple-400 to-teal-400 bg-clip-text text-transparent leading-tight">
                🏆 RESULTS ANNOUNCED 🏆
              </h2>
