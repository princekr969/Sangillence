        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            {getVisibleTestimonials().map((feature, index) => (
              <div
                key={index}
                className={`group bg-white p-8 rounded-2xl shadow-sm border border-gray-100 transition-all duration-500 transform ${index === 1 ? 'scale-105 bg-white shadow-lg' : 'hover:shadow-md'
                  }`}
              >
